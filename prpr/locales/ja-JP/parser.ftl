...
# rpe
type-events-parse-failed = { $type }イベント分析失敗
incline-events-parse-failed = Inclineイベント分析失敗
paint-events-parse-failed = Paintイベント分析失敗
text-events-parse-failed = Textイベント分析失敗
color-events-parse-failed = Colorイベント分析失敗
gif-events-parse-failed = GIFイベント分析失敗
