...
hykb-other-login-notice = 只有綁定了好游快爆的賬號才可以登入遊戲。
hykb-other-login-not-bound = 該賬號未綁定好游快爆，無法登入
hykb-bind-required-title = 需要綁定好游快爆
hykb-bind-required = 該賬號尚未綁定好游快爆，需要綁定後才能登入遊戲。
hykb-bind-required-confirm = 綁定好游快爆
