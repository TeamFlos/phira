...
item-adjust-sub = Ajuste le temps dynamiquement pour synchroniser la musique et la partition
...
item-dhint = Indication d'appui double
item-dhint-sub = Les notes qui touchent la ligne simultanément seront mises en surbrillance
item-opt = Optimisation agressive
item-opt-sub = Cela améliorera les performances, mais peut entraîner des comportements incorrects
item-speed = Vitesse
