...
item-offline-sub = В офылайн режиме вы не сможете загружать свой результат
...
item-autoplay = Автоигра
item-autoplay-sub = Когда опция включена вы не сможете загружать на сервер результаты
