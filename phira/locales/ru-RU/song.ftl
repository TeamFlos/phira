...
delete = Удалить
exercise = Режим практики
offset = Настроить задержку
...
upload-rules-content =
  ...
  1. Вы должны являться автором чарта или иметь разрешение автора чарта, если вы не являетесь его автором. Во втором случае в описании необходимо указать автора чарта;
  2. Если вы являетесь автором чарта, то рекомендуется использовать узнаваемый никнейм и фото профиля. Если ваши никнейм и фото профиля отличаются от тех что находятся на используемой вами платформе для передачи чартов(YouTube или Discord), обозначьте это дополнительно.
  3. ! Нарушение правил или загрузка чужого чарта без солгасия автора карается перманентной блокировкой возможности выкладывать чарты;
  4. Содержимое чарта(трек,текст, иллюстрация и.т.д,) не должны нарушать законов Китайской Народной Республики и содержать недостоверную информацию.
