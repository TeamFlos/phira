...
edit-downloaded = Вы не можете редактировать загруженыые чарты
...
upload-downloaded = Загруженные чарты нельзя выложить
upload-rules = Правила
upload-rules-content =
  Перед тем как выложить чарт, ознакомьтесь с требованиями.
  1. Вы должны являться автором чарта.
  2. Рекомендуется использовать узнаваемый никнейм и фото профиля. Если ваши никнейм и фото профиля отличаются от тех что находятся на используемой вами платформе для передачи чартов(YouTube или Discord), обозначьте это дополнительно.
  3. ! Нарушение правил или загрузка чужого чарта без согласия автора карается перманентной блокировкой возможности выкладывать чарты;
  4. Содержимое чарта(трек,текст, иллюстрация и.т.д,) не должны нарушать законов Китайской Народной Республики и/или содержать недостоверную информацию.
  5. Вы предоставляете право использования вашего чарта для его продвижения в Phira. Для любого иного использлвания требуется ваше разрешение. 
  6.Право на конечную интерпретацию пятого правила остаëтся за TeamFlos. 
