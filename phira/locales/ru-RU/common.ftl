...
tos-accept = Согласен
tos-link-terms = Условия Использования
tos-link-privacy = Политика Конфиденциальности
...
favorites-online-only = В онлайн-избранное можно сохранить только опубликованные чарты. Локальные чарты: { $charts }
contains-banned-words = Ваш ввод содержит запрещённые слова, пожалуйста, проверьте и отправьте заново.
