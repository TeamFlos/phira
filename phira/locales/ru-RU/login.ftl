...
name-length-req = Длина никнейма не может быть меньше 4-х или больше 20 символов.
name-has-illegal-char = В никнейме есть неподходящие символы.
pwd-length-req = Длина пароля не может быть меньше 6 или больше 26 символов.
