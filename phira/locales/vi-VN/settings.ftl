...
item-clear-cache = Làm sạch Cache
item-cache-size-loading = Đang tải…
item-cache-size = Kích cỡ Cache: { $size }
item-clear-cache-btn = Dọn dẹp
item-cache-cleared = Đã làm sạch Cache
