...
about-content =
  ...
  Phira là một trò chơi nhịp điệu hướng đến cộng đồng phi thương mại, lấy cảm hứng từ Phigros, được phát triển cùng với Rust.

  Nếu bạn thấy thích thú với trò chơi này, xin hãy cân nhắc ủng hộ chúng tôi trên Patreon (@PhiraGame) hoặc afdian.com (@Mivik). Sự ủng hộ của bạn chính là động lực lớn nhất cho chúng tôi!
  
  Tài khoản Bili Bili: @Phira官方
  Hội QQ: r48eajexth
